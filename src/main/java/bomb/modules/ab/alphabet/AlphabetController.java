...
import core.bomb.modules.ab.alphabet.Alphabet;
...
import static tools.pattern.factory.TextFormatterFactory.createOneLetterFormatter;
...
public class AlphabetController implements Resettable {
    ...
    @Override
    public void reset() {
        MFXTextField[] fields  = {firstInput, secondInput, thirdInput, forthInput, firstOutput, secondOutput,
                thirdOutput, forthOutput};
        FacadeFX.clearMultipleTextFields(fields);
    }
}

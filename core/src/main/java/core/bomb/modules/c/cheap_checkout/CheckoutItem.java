package core.bomb.modules.c.cheap_checkout;
...
import static core.bomb.modules.c.cheap_checkout.CheckoutItem.Category.CARE;
import static core.bomb.modules.c.cheap_checkout.CheckoutItem.Category.DAIRY;
import static core.bomb.modules.c.cheap_checkout.CheckoutItem.Category.FRUIT;
import static core.bomb.modules.c.cheap_checkout.CheckoutItem.Category.GRAIN;
import static core.bomb.modules.c.cheap_checkout.CheckoutItem.Category.OIL;
import static core.bomb.modules.c.cheap_checkout.CheckoutItem.Category.OTHER;
import static core.bomb.modules.c.cheap_checkout.CheckoutItem.Category.PROTEIN;
import static core.bomb.modules.c.cheap_checkout.CheckoutItem.Category.SWEET;
import static core.bomb.modules.c.cheap_checkout.CheckoutItem.Category.VEGETABLE;
import static core.bomb.modules.c.cheap_checkout.CheckoutItem.Category.WATER;

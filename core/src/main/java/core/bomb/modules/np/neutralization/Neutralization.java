package core.bomb.modules.np.neutralization;
...
import static core.bomb.Widget.IndicatorFilter.ALL_PRESENT;
...
import static core.bomb.modules.np.neutralization.Chemical.Acid.HYDROBROMIC_ACID;
import static core.bomb.modules.np.neutralization.Chemical.Acid.HYDROCHORIC_ACID;
import static core.bomb.modules.np.neutralization.Chemical.Acid.HYDROFLUORIC_ACID;
import static core.bomb.modules.np.neutralization.Chemical.Acid.HYDROIODIC_ACID;
import static core.bomb.modules.np.neutralization.Chemical.Base.AMMONIA;
